...
def main():
    ...
    # 加载文件夹中的图像，限制每类图像加载数
    original_images, original_labels = load_images_from_folder(original_folder, 'original', limit=10)
    first_migration_images, first_migration_labels = load_images_from_folder(first_migration_folder, 'first_migration', limit=10)
